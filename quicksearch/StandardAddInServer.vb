...
Namespace quicksearch
    <ProgIdAttribute("quicksearch.StandardAddInServer"), _
    GuidAttribute("d1106736-7f9d-4958-bb0d-704f354a2df8")> _
...
#Region "Function to get the add-in client ID."
    ...
    Public Function AddInClientID() As String
        Dim guid As String = ""
        Try
            Dim t As Type = GetType(quicksearch.StandardAddInServer)
